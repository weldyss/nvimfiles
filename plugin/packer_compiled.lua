...
_G.packer_plugins = {
  ...
  ["calendar-vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/calendar-vim",
  ...
  ["elixir.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/elixir.nvim",
  ...
  ["lf.nvim"] = {
    ...
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/lf.nvim",
  ...
  ["promise-async"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/promise-async",
    url = "https://github.com/kevinhwang91/promise-async"
  },
  ["ruby-code-actions.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/ruby-code-actions.nvim",
